package com.fissher.wowtc.model;
...
import com.fissher.wowtc.utils.RankDescriptionsProvider;
import com.fissher.wowtc.utils.TalentIcons;
import com.fissher.wowtc.utils.TalentNames;
...
public class TalentTree {
    ...
    public void showDialog(final Activity activity, final int talentId, String method) {
        ...
        if(method!=null)
        {
            if(method.contains("View"))
            {
                add.setVisibility(View.GONE);
                remove.setVisibility(View.GONE);
                nextRankDesc.setVisibility(View.GONE);
            }
        }
